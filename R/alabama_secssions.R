alabama_secessions <- function(){
  ...
  for(i_secession in 1:nrow(al_secessions)){
    ...
    secess_new_ncesid <- al_secessions[i_secession]$seceding_district_ncesid
    secess_from_ncesid <- al_secessions[i_secession]$seceded_from_district_ncesid
    secess_id <- al_secessions[i_secession]$secession_id
